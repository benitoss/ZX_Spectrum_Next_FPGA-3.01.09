## Generated SDC file "zxnext_UAReloaded.out.sdc"
...
set_clock_uncertainty -rise_from [get_clocks {clocks_inst|altpll_component|auto_generated|pll1|clk[0]}] -rise_to [get_clocks {clock_50_i}] -setup 0.090  
set_clock_uncertainty -rise_from [get_clocks {clocks_inst|altpll_component|auto_generated|pll1|clk[0]}] -rise_to [get_clocks {clock_50_i}] -hold 0.060  
set_clock_uncertainty -rise_from [get_clocks {clocks_inst|altpll_component|auto_generated|pll1|clk[0]}] -fall_to [get_clocks {clock_50_i}] -setup 0.090  
set_clock_uncertainty -rise_from [get_clocks {clocks_inst|altpll_component|auto_generated|pll1|clk[0]}] -fall_to [get_clocks {clock_50_i}] -hold 0.060  
...
set_clock_uncertainty -fall_from [get_clocks {clocks_inst|altpll_component|auto_generated|pll1|clk[0]}] -rise_to [get_clocks {clock_50_i}] -setup 0.090  
set_clock_uncertainty -fall_from [get_clocks {clocks_inst|altpll_component|auto_generated|pll1|clk[0]}] -rise_to [get_clocks {clock_50_i}] -hold 0.060  
set_clock_uncertainty -fall_from [get_clocks {clocks_inst|altpll_component|auto_generated|pll1|clk[0]}] -fall_to [get_clocks {clock_50_i}] -setup 0.090  
set_clock_uncertainty -fall_from [get_clocks {clocks_inst|altpll_component|auto_generated|pll1|clk[0]}] -fall_to [get_clocks {clock_50_i}] -hold 0.060  

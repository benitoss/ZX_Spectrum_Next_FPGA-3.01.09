...
# ----------------------------------------
# If next_clocks is one of several IP cores in your
...
# ----------------------------------------
# ACDS 17.0 595 win32 2020.11.01.19:15:59
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "next_clocks"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/next_clocks.vho"
}
